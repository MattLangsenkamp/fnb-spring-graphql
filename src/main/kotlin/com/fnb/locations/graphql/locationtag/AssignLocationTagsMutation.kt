...
@Component
class AssignLocationTagsMutation
@Autowired constructor(
    ...
    suspend fun assignTags(graphQLContext: MyGraphQLContext, tags: List<LocationTag>, locationId: Int): List<LocationTag> {
        ...
        return locationTagService.assignTags(loggedInUser, tags, location)
    }
}